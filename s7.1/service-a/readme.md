...
This will create an executable jar file **s7.1.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/s7.1.jar
